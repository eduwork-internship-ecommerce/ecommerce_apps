        ...
        <div class="max-w-lg mx-auto bg-white p-6 md:p-10 rounded-lg shadow-lg">
            <form action="#" method="POST">
                <div class="grid grid-cols-1 gap-4 mb-4">
                    ...
                    {{-- Tambahkan form input nomor telepon di sini --}}
                    <div>
                        <label for="phone" class="block font-medium text-gray-700 mb-1">Nomor Telepon</label>
                        <input type="tel" id="phone" name="phone" class="w-full px-4 py-3 border border-gray-300 rounded-md focus:ring-amber-500 focus:border-amber-500 transition-colors duration-200">
                    </div>
                </div>
                <div class="mb-6">
                    {{-- The label text will inherit the body's font-size from style.css --}}
