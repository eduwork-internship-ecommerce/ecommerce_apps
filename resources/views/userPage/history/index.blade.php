...
<div class="max-w-6xl mx-auto px-4 py-10">
    ...
    {{-- Asumsi data pesanan dioper ke view sebagai variabel $orders --}}
    @php
...
{{-- Skrip Helper JavaScript untuk Alpine.js --}}
<script>
    // Memastikan fungsi PHP formatStatus dan formatDate tersedia di scope global untuk Alpine.js
    // Catatan: Di implementasi nyata, Anda harus mendefinisikan ini di Alpine.data atau memastikan datanya sudah diformat di PHP.
...
{{-- Skrip Alpine.js (Diperlukan untuk Modal) --}}
{{-- Biasanya, ini di-load di layout utama, tapi disertakan di sini untuk kelengkapan file tunggal --}}
